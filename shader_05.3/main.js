(()=>{
  ...
  function initGLData() {
    ...
    gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, gl.RGBA, gl.UNSIGNED_BYTE, faceTexture);
  ...
  faceTexture = new Image();
  faceTexture.addEventListener('load', ()=> {
  ...
  // faceTexture.src = "../images/bumpy.jpeg";
  // faceTexture.src = "../images/rust.jpg";
  // faceTexture.src = "../images/f.png";
  // faceTexture.src = "../images/world.png";
  // faceTexture.src = "../images/dnb_land_ocean_ice.2012.3600x1800.jpg";
  faceTexture.src = "../images/nasa_blue_marble.4096.jpg";
  // dnb_land_ocean_ice.2012.3600x1800.jpg courtesy of NASA
