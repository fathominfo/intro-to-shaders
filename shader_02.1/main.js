(()=>{
  var canvas = document.getElementById('shade'),
    ...
    // New: we have a new global variable that represents the screen size
  ...
  function initGLData() {
    ...
    gl.viewport(0, 0, W, H);
    // New: just where does the shader store the information about screen resolution?
    resolutionUniformLocation = gl.getUniformLocation(program, "u_resolution");
    // New: pass in the width and height of the canvas so we can use it in the shader
